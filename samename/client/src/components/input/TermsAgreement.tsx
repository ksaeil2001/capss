    ...
    <div className="space-y-4">
      ...
      <div className="border-b pb-3 mb-3">
        <div className="flex items-start">
          ...
          <div className="ml-3">
            <label htmlFor="all-terms" className="font-bold text-base text-gray-800">모든 약관에 동의합니다</label>
        ...
        {requiredAgreements.map((agreement) => (
          <div key={agreement.id} className="flex items-start">
            ...
            <div className="ml-3 text-sm">
              <label htmlFor={agreement.id} className="font-medium text-gray-700">{agreement.title}</label>
